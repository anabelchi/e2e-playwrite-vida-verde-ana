...
def test_realizar_compra_datos_validos(page: Page):
    ...
    checkout_page.verificar_resumen_de_pedido()

    print("and nombre del producto es 'Juego de Palas'")
    checkout_page.verificar_nombre_del_producto("Juego de Palas")

    print("And el precio del producto es '15.99 €'")
    checkout_page.verificar_precio_del_producto("15.99 €")

    print("And el subtotal del producto es '15.99 €'")
    checkout_page.verificar_subtotal("15.99 €")

    print("and el iva es '3.36 €'")
    checkout_page.verificar_iva("3.36 €")

    print("and el envio es '5.00 €'")
    checkout_page.verificar_coste_envio("5.00 €")
    ...
    checkout_page.rellenar_dirección("Calle del Árbol, 8, Burgos")

    print("and rellena la tarjeta válida '4242 4242 4242 4242'")
    checkout_page.rellenar_tarjeta_credito("4242 4242 4242 4242")
    ...
    confirmacion_page.verificar_mensaje_exito("¡Compra Realizada con Éxito!")

    print("and debe ver el resumen del pedido con el producto 'Juego de Palas'")
    confirmacion_page.verificar_nombre_del_producto("Juego de Palas")

    print("and el precio del producto '15.99 €'")
    confirmacion_page.verificar_precio_del_producto("15.99 €")

    print("and el subtotal '15.99 €'")
    confirmacion_page.verificar_subtotal("15.99 €")

    print("and el iva '3.36 €'")
    confirmacion_page.verificar_iva("3.36 €")

    print("and el envio '5.00 €'")
    confirmacion_page.verificar_coste_envio("5.00 €")

    print("and el total '24.35 €'")
    confirmacion_page.verificar_total("24.35")

    print("and hace clic el botón 'Ir al Inicio'")
    confirmacion_page.ir_al_inicio()
    ...
    inicio_page.verificar_url("https://web-qa.dev.adalab.es/")

    # Comprobamos que el título de la página sea 'Vida Verde'
    inicio_page.verificar_titulo_heading("Vida Verde")
    ...
    inicio_page.verificar_boton_ver_productos("Ver Productos")
...
def test_realizar_compra_con_tarjeta_invalida(page: Page):
    ...
    checkout_page.rellenar_tarjeta_credito("1234")

    print("and hace clic en Completar Compra")
    checkout_page.completar_compra()

    print("then debe ver un mensaje de error numero de tarjeta invalido")
    checkout_page.verificar_mensaje_tarjeta_erronea(
        "El número de tarjeta debe")
...
def test_realizar_compra_con_tarjeta_vacia(page: Page):
    ...
    confirmacion_page.verificar_no_mensaje_exito("Compra realizada con éxito")
